...
e_df_batch = CSV.File("insert_h2o_dimer/h2o_dimer_4500_mc_n1000_batch/energy_log_H2O_tip4p_dimer_4500.0_n1000_batch.tsv") |> DataFrame
e_df_batch.e_total = e_df_batch.gh_vdw .+ e_df_batch.gh_q .+ e_df_batch.gg_vdw .+ e_df_batch.gg_q
e_df_baseline = CSV.File("insert_h2o_dimer/h2o_dimer_4500_mc_n1000_baseline/energy_log_H2O_tip4p_dimer_4500.0_n1000_baseline.tsv") |> DataFrame
...
function eplots(e_df, ebounds, nbounds; legend=false, y_formatter=:plain, noylabel=false, title="")
  ...
  eplot = plot(e_df.cycle, e_df.gh_vdw / 1000, label="Guest-host VDW",
            xlims = 0:695000, xticks= 0:120_000:695000, xlabel="MC Move Index",
  ...
  nplot = plot(e_df.cycle, e_df.num_adsorbates, label="",
            xlims = 0:695000, xticks= 0:120_000:695000, xformatter=_->"",
...
baselinee, baselinen = eplots(e_df_baseline, ebounds, nbounds, legend=:right,
